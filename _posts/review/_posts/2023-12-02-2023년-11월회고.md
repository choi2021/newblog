...
[![Watch the video](https://github.com/choi2021/choi2021.github.io/assets/80830981/720e5c16-a5f2-4639-90eb-2933ab81694a)]
...
[![Watch the video](https://github.com/choi2021/choi2021.github.io/assets/80830981/6b5ee963-7d7f-4210-bcb8-0240eb92fc19)](https://youtu.be/T-D1KVIuvjA)
...
에러바운더리의 장점을 알고 적용하려고 보니 렌더링 에러만 감지할 수 있는 한계점이 있었다. 우리가 자주 사용하는 비동기와 이벤트 핸들러에서 발생한 에러에서도 적용하는 방법은 없을까라는 생각이 든다. 이러한 한계를 극복하기 위한 라이브러리로 [React-Error-Boundary](https://github.com/bvaughn/react-error-boundary)가 있다. React-Error-Boundary를 사용하는 방법으로 먼저 몇가지 소개했다.
